...
if ( defined( 'JETPACK__VERSION' ) ) {
 ...
 function tasko_custom_excerpt_more($more) {
 	global $post;
 	return ' <a class="more-link" href="'. get_permalink($post->ID). '">'. __('Read More','tasko') .'</a>';
}
add_filter('exceprt_more','tasko_custom_excerpt_more'); 
 

// //custom excerpt length

 function tasko_custom_excerpt_length( $length ) {
 	return 45;
 }
 add_filter('excerpt_length', 'tasko_custom_except_length',999);

// custom image size

add_image_size('post-size', 450, 300,true);
